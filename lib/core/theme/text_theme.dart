...
class NTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    bodySmall: TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w500, color: NColors.primary),
    labelLarge: TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w400, color: Colors.black),
    labelMedium: TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.w400, color: NColors.primary),
